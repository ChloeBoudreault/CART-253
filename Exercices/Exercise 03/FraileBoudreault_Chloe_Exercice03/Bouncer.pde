...
//CHANGED!!!!!!!!
//added new method to the bouncer class
//this checks whether or not the mouse is clicked
//if it is clicked, the sizes of the balls will change randomly and so on
  void sizeChange () {
    if (mouseClick == true) {
    size = floor (random(40));
  }
  }
